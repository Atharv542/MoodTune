...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch("https://atharv542-moodtune-backend.hf.space/dashboard-data");
    ...
    <div className="container mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-gray-900 p-4 rounded-lg">
          ...
          <img src="https://atharv542-moodtune-backend.hf.space/plot/top3.png" alt="Top3" />
          <div className="mt-4">
        ...
        <div className="bg-gray-900 p-4 rounded-lg">
          ...
          <img src="https://atharv542-moodtune-backend.hf.space/plot/daily.png" alt="Daily" />
