...
export default function Dashboard() {
  ...
  const fetchData = async () => {
    try {
      const res = await fetch("https://moodtune-1-w0jn.onrender.com/dashboard-data");
    ...
    <div className="container mx-auto px-6 py-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-gray-900 p-4 rounded-lg">
          ...
          <img src="https://moodtune-1-w0jn.onrender.com/plot/top3.png" alt="Top3" />
          <div className="mt-4">
        ...
        <div className="bg-gray-900 p-4 rounded-lg">
          ...
          <img src="https://moodtune-1-w0jn.onrender.com/plot/daily.png" alt="Daily" />
